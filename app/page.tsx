      ...
      <section className="px-6 py-32 bg-[#8b4513] text-[#f0f0e8] border-b-2 border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto text-center">
          <blockquote className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-tight mb-8">
            &ldquo;Every site we build has a map. They all looked the same
            until brandmap.&rdquo;
          </blockquote>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="bg-[#1a1a1a] text-[#f0f0e8] border-2 border-[#1a1a1a] shadow-[12px_12px_0px_0px_var(--shadow-accent)] p-10 md:p-14 w-full max-w-lg flex flex-col">
