        ...
        <div className="bg-white border-2 border-[#1a1a1a] shadow-[6px_6px_0px_0px_#1a1a1a] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#8b4513] text-[#f0f0e8] border-2 border-[#1a1a1a] font-black text-sm uppercase tracking-wider hover:bg-[#a0522d] transition-colors disabled:opacity-50"
            >
